...
public class MessageProcessor implements Runnable {
    ...
    private static class TelegaStatusUpdateListener implements StatusUpdateListener {

        private final MessageSender messageSender;
        private final Long chatId;

        public TelegaStatusUpdateListener(MessageSender messageSender, Long chatId) {
            this.messageSender = messageSender;
            this.chatId = chatId;
        }
